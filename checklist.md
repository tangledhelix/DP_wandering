...
"The Wandering Jew" by Conway, Moncure Daniel
...
./make_project.py
```
* [x] Read the [project comments](https://www.pgdp.net/c/project.php?id=projectID60243a9325858#project-comments)
* [x] Subscribe to the [forum topic](https://www.pgdp.net/phpBB3/viewtopic.php?t=73168) and read all posts
* [x] Open `wandering-utf8.txt` in Guiguts
...
* [ ] Go to [project page](https://www.pgdp.net/c/project.php?id=projectID60243a9325858), select SR time period, upload `wandering-sr.zip`
...
* [ ] Add **anonymized** files to git, e.g. `wandering-smoothread01.txt`
...
* [ ] Enter copyright clearance (get from DP [project page](https://www.pgdp.net/c/project.php?id=projectID60243a9325858))
...
* [ ] Credits line
  * Paste in from DP [project page](https://www.pgdp.net/c/project.php?id=projectID60243a9325858)
